...
def subscription_handler(account_info_obj, update_nr, subscription_id):
    ...
    if update_nr > 0:
        ...
        snapshot_nominator_mapping_file_path    = snapshot_path + era + "_snapshot_nominator_mapping.json"
        snapshot_validator_mapping_file_path    = snapshot_path + era + "_snapshot_validator_mapping.json"
