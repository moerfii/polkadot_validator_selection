...
def solve_validator_selection(dataframe):
    ...
    # solve the problem
    problem.solve(verbose=True, solver=cp.SCS, max_iters=10000, eps=1e-8, use_indirect=True, normalize=True)
...
if __name__ == "__main__":
    ...
    dataframe = pd.read_csv("../data/model_2/df_bond_distribution_testing_0.csv")
